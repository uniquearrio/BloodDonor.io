    ...
    <body>
		...
		<nav class="navbar navbar-inverse">
			  <div class="container-fluid">
                ...
                <a class="navbar-brand" href="index.php"><i class="icofont-blood-drop"></i>သင့်သွေးဖြင့်အသက်ကယ်ပါ</a>
				</div>

				<ul class="nav navbar-nav navbar-right">
				  <!-- <li><a href="#"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li> -->
                  
				  <li><a href="userlog/userlogin.php" ><span class="glyphicon glyphicon-user" style="color:white;"></span> User Login</a></li>
				</ul>
			  </div>
		</nav>
            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <div class="login-panel panel panel-default">
                        ...
                        <div class="panel-body" style="background-color: rgb(255,97,97,56%)">
                            <form role="form">
                                <fieldset>
                                    <div class="form-group">
                                        <input class="form-control" placeholder="အမည်" name="user" type="text" autofocus>
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" placeholder="စကားဝှက်" name="pass" type="password" value="">
                                    </div>
                                    <div class="checkbox">
                                        <label>
                                            <input name="remember" type="checkbox" value="Remember Me">အမည်နှင့်စကားဝှက်အားမှတ်ထားမည်
                                        </label>
                                    </div>
                                    <!-- Change this to a button or input when using this as a form -->
                                    <input type="submit" class="btn btn-info btn-block" style="border-radius:8px; background-color: red;" title="Log In" name="login" value="Login"></input>
                                </fieldset>
