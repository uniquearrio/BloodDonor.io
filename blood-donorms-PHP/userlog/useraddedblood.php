...
<body>
    ...
    <?php include 'includes/donornav.php'?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" style="line-height:1.7;">လှူးဒါန်းလိုက်သောသွေးရည်ကြည့်ဖြင့် <br><br> လူတစ်ယောက်အသက်ဆက်နိုင်သည်...</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
							...
							if(isset($_POST['name'])){
								...
								if(!$result){
									...
									echo" <div style='text-align: center'><h1>အောင်မြင်စွာစာရင်းသွင်းပြီးပါပြီ။ ကျေးဇူးတင်ပါသည်။</h1>";
									echo" <a href='userdashboard.php' div style='text-align: center'><h3>ထွက်မည်</h3>";
